...
class ListPenyakitKeluarga extends StatelessWidget {
  const ListPenyakitKeluarga({
    super.key,
    required PenyakitKeluargaModel? penyakitKeluarga,
  }) : _penyakitKeluarga = penyakitKeluarga;

  final PenyakitKeluargaModel? _penyakitKeluarga;
