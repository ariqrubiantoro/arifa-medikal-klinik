...
class ListFisik extends StatelessWidget {
  const ListFisik({
    super.key,
    required FisikModel? fisik,
  }) : _fisik = fisik;

  final FisikModel? _fisik;
...
class ListKimia extends StatelessWidget {
  const ListKimia({
    super.key,
    required KimiaModel? kimia,
  }) : _kimia = kimia;

  final KimiaModel? _kimia;
...
class ListBiologi extends StatelessWidget {
  const ListBiologi({
    super.key,
    required BiologiModel? biologi,
  }) : _biologi = biologi;

  final BiologiModel? _biologi;
...
class ListPsikologis extends StatelessWidget {
  const ListPsikologis({
    super.key,
    required PsikologiModel? psikologi,
  }) : _psikologi = psikologi;

  final PsikologiModel? _psikologi;
...
class ListErgonomis extends StatelessWidget {
  const ListErgonomis({
    super.key,
    required ErgonomisModel? ergonomis,
  }) : _ergonomis = ergonomis;

  final ErgonomisModel? _ergonomis;
