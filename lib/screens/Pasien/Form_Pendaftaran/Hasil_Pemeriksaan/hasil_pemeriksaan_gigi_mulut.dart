...
class HasilPemeriksaanGigiMulut extends StatefulWidget {
  HasilPemeriksaanGigiMulut({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanGigiMulut> createState() =>
      _HasilPemeriksaanGigiMulutState();
}

class _HasilPemeriksaanGigiMulutState extends State<HasilPemeriksaanGigiMulut> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan Gigi Mulut";
    getData();
    super.initState();
  }
  ...
  getData() async {
    _hasilPemeriksaan =
        await firestore.getHasilPemeriksaanGigi(widget.idPasien);
    setState(() {
