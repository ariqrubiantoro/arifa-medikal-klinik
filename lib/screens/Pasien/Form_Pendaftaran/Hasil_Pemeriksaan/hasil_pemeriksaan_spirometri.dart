...
class HasilPemeriksaanSpirometri extends StatefulWidget {
  HasilPemeriksaanSpirometri({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanSpirometri> createState() =>
      _HasilPemeriksaanSpirometriState();
}

class _HasilPemeriksaanSpirometriState
    extends State<HasilPemeriksaanSpirometri> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan Spirometri";
    getData();
    super.initState();
  }
