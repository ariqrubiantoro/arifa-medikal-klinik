...
class HasilPemeriksaanNapfa extends StatefulWidget {
  HasilPemeriksaanNapfa({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanNapfa> createState() => _HasilPemeriksaanNapfaState();
}

class _HasilPemeriksaanNapfaState extends State<HasilPemeriksaanNapfa> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan NAPFA";
  ...
  getData() async {
    _hasilPemeriksaan =
        await firestore.getHasilPemeriksaanNapfa(widget.idPasien);
    setState(() {
  ...
  saveButton() async {
    ...
    firestore.setHasilPemeriksaanNapfa(
