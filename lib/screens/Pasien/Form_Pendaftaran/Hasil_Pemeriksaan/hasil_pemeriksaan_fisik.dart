...
class HasilPemeriksaanFisik extends StatefulWidget {
  HasilPemeriksaanFisik({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanFisik> createState() => _HasilPemeriksaanFisikState();
}

class _HasilPemeriksaanFisikState extends State<HasilPemeriksaanFisik> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan Fisik";
    getData();
    super.initState();
  }
  ...
  getData() async {
    _hasilPemeriksaan =
        await firestore.getHasilPemeriksaanFisik(widget.idPasien);
    setState(() {
