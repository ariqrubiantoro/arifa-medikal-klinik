...
class HasilPemeriksaanLaboratorium extends StatefulWidget {
  HasilPemeriksaanLaboratorium({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanLaboratorium> createState() =>
      _HasilPemeriksaanLaboratoriumState();
}

class _HasilPemeriksaanLaboratoriumState
    extends State<HasilPemeriksaanLaboratorium> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan Laboratorium";
    getData();
    super.initState();
  }
