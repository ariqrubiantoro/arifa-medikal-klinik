...
class HasilPemeriksaanTreadmill extends StatefulWidget {
  HasilPemeriksaanTreadmill({super.key, required this.idPasien});
  String idPasien;
  @override
  State<HasilPemeriksaanTreadmill> createState() =>
      _HasilPemeriksaanTreadmillState();
}

class _HasilPemeriksaanTreadmillState extends State<HasilPemeriksaanTreadmill> {
  ...
  @override
  void initState() {
    judulConn.text = "Hasil Pemeriksaan Treadmill";
    getData();
    super.initState();
  }
