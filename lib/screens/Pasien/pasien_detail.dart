          ...
          build: (pw.Context context) {
            return [
              ...
              pw.Container(
                width: 100,
                height: 60,
                margin: pw.EdgeInsets.only(left: 55),
                child: pw.Image(
              ...
              pw.Row(
                  ...
                  children: [
                    pw.SizedBox(width: 5),
                    pw.Text("SK KEMENAKER : 5/7118/AS.01.04/XII/2022",
                        style: pw.TextStyle(
                          fontSize: 11,
                          fontWeight: pw.FontWeight.bold,
                        )),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Expanded(
              child: Container(
                child: textDefault("LED", Colors.black, 12, FontWeight.normal),
              ),
            ),
            Container(
              child: textDefault(":  ", Colors.black, 12, FontWeight.normal),
            ...
            Expanded(
              child: Container(
                child: textDefault(
                    "${_hasilLaboratorium == null ? "" : _hasilLaboratorium!.led ?? ""}          mm/jam",
                    Colors.black,
                    12,
                    FontWeight.normal),
              ),
        ...
        Row(
          ...
          children: [
            Expanded(
              child: Container(
                child: textDefault(
                    "Bilirubin Indirect", Colors.black, 12, FontWeight.normal),
              ),
            ),
            Container(
              child: textDefault(":  ", Colors.black, 12, FontWeight.normal),
            ...
            Expanded(
              child: Container(
                child: textDefault(
                    "${_hasilLaboratorium == null ? "" : _hasilLaboratorium!.bilirubinIndirect ?? ""}          mg/dl",
                    Colors.black,
                    12,
                    FontWeight.normal),
              ),
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Container(
                child: textDefault(
                    "${_hasilLaboratorium == null ? "" : _hasilLaboratorium!.leukositUrinalisa}          /ul",
                    Colors.black,
                    12,
                    FontWeight.normal),
              ),
        ...
        Row(
          ...
          children: [
            Expanded(
              child: Container(
                child: textDefault(
                    "Golongan Darah", Colors.black, 12, FontWeight.normal),
              ),
            ),
            Container(
              child: textDefault(":  ", Colors.black, 12, FontWeight.normal),
            ...
            Expanded(
              child: Container(
                child: textDefault(
                    "${_hasilLaboratorium == null ? "" : _hasilLaboratorium!.golonganDarah ?? ""}         ",
                    Colors.black,
                    12,
                    FontWeight.normal),
              ),
